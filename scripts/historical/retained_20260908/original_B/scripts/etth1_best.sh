...
export FINETUNE_LR_LIST="2e-4 2e-4 2e-4 2e-4"
export TARGET_POINTS_LIST="96 192 336 720"
export FORECAST_STEP_SIZE_LIST="3 6 6 9"
export FORECAST_PRED_LEN_LIST="6 12 12 18"
...
export GUMBEL_TEMPERATURE_LIST="0.8 0.8 0.8 0.8"
export GUMBEL_TEMPERATURE=0.8
export GUMBEL_HARD=0
export TRAIN_LOSS=huber
export HUBER_DELTA_LIST="1.0 1.0 1.0 1.0"
