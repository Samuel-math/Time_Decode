#!/bin/bash
# =====================================================================
# Weather merged channel-group runner.
#
# Merges:
#   scripts/weather_96.sh
#   scripts/weather_192.sh
#   scripts/weather_336.sh
#   scripts/weather_720.sh
#
# Usage from repo root:
#   bash scripts/weather.sh
#   HORIZONS="96 192" bash scripts/weather.sh
#   HORIZONS="96,192,336,720" bash scripts/weather.sh
# =====================================================================
...
validate_horizons() {
    ...
    for h in ${HORIZONS}; do
        case "${h}" in
            96|192|336|720) ;;
            *)
                echo "ERROR: unsupported Weather horizon '${h}'. Allowed: 96 192 336 720" >&2
                exit 1
                ;;
        esac
    done
...
print_config() {
    echo "================================================="
    echo "Weather merged channel-group run: ${1}"
    echo "================================================="
    ...
    echo "TimeFilter topk        : ${TIMEFILTER_TOPK}"
...
run_profile() {
    ...
    case "${horizon}" in
        96)
            ...
            export FORECAST_STEP_SIZE_LIST=6
...
echo "================================================="
echo "Weather merged run finished: ${HORIZONS}"
echo "================================================="
