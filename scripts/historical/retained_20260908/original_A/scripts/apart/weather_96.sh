...
export MAX_CHANNELS_PER_MODEL=21
...
export FORECAST_STEP_SIZE_LIST="${FORECAST_STEP_SIZE_LIST:-6}"
export FORECAST_PRED_LEN_LIST="${FORECAST_PRED_LEN_LIST:-6}"
...
echo "================================================="
echo "Weather channel-group run"
echo "================================================="
