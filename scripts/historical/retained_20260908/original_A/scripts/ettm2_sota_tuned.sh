#!/bin/bash
# =====================================================================
# ETTm2 SOTA-tuned channel-group runner.
#
# Merges:
#   scripts/ettm2_96.sh
...
setup_common() {
    ...
    export RUN_HISTORY_PREFIX="${RUN_HISTORY_PREFIX:-ettm2_sota_tuned}"
    export RETAIN_RUNS="${RETAIN_RUNS:-20}"
...
run_96_192_336_profile() {
    ...
    setup_common
    export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES_96_336:-${CUDA_VISIBLE_DEVICES:-0}}"
...
run_720_profile() {
    ...
    setup_common
    export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES_720:-${CUDA_VISIBLE_DEVICES:-0}}"
