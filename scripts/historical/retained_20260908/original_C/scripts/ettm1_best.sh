...
export RUN_HISTORY_PREFIX="${RUN_HISTORY_PREFIX:-${DSET}_pred96_freq_m${MAX_CHANNELS_PER_MODEL}_base${BASE_MODEL_ID}}"
...
export FORECAST_STEP_SIZE_LIST="${FORECAST_STEP_SIZE_LIST:-3 4 7 8}"
