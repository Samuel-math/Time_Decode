...
root=search_etth2_mae_finish_r1; mkdir -p "$root"
...
pbase=decoder_only_NTP/saved_models/patch_vqvae/etth2_freq_m7_base1_20260831_011724/etth2/patch_vqvae_ps8_cb256_cd128_l3_in296_step3_model1_rvq2_grp0.pth
