...
root="${TD_FINETUNE_ROOT:-search_electricity_96_fixed96_r3}"
mkdir -p "$root"
...
python -u decoder_only_NTP/patch_vqvae_finetune.py --dset electricity --context_points 96 --target_points 96 --batch_size 32 --num_workers 0 \
 ...
 --selection_metric mse --use_gumbel_softmax 1 --gumbel_temperature .8 --gumbel_hard 0 --ar_step_size 8 --pred_len 10 \
